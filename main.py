...
if choice1=="left":
    choice2=input("You\'ve come to a lake,there is an island in the middle of the lake."
          "Type 'wait' to wait for the boat or type 'swim' to swim for the boat\n").lower()
    if choice2=="wait":
        #game will continue
        choice3=input("You arrived at the island unharmed."
              "There is house with 3 doors.One red,One Yellow and one blue.Which color do you want to choose?\n").lower()
        if choice3=="red":
            ...
            print("You chose a door that doesn\'nt exist")
